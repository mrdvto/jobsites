...
export const CreateOpportunityModal = ({ siteId, open, onOpenChange }: CreateOpportunityModalProps) => {
        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={stageId} onValueChange={setStageId}>
              ...
              <SelectContent>
                {opportunityStages
                  .filter(stage => stage.phaseid === 2) // Outstanding opportunities only
                  .map(stage => (
