...
import { useOpportunityTypes } from '@/hooks/useLookups';
import { useUpdateOpportunity } from '@/hooks/useOpportunities';
import { getStageName, getTypeName } from '@/lib/lookupHelpers';
...
export const OpportunityDetailModal = ({ opportunity, open, onOpenChange }: OpportunityDetailModalProps) => {
  ...
  const handleEstCloseChange = (month: string, year: string) => {
    ...
    updateOpportunity.mutate({ opportunityId: opportunity.id, updates });
    toast.success('Est. close date updated.');
  };
        ...
        <DialogHeader>
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <Badge variant="secondary">{getTypeName(types, opportunity.typeId)}</Badge>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                ...
                <p className="font-medium">{getStageName(stages, opportunity.stageId)}</p>
              </div>
              <div>
