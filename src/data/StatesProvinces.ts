...
const australianStates: StateProvince[] = [
...
const allStatesProvinces: StateProvince[] = [...usStates, ...canadianProvinces, ...australianStates];
...
// Simulated API call
export const fetchStatesProvinces = (countryCode: string): Promise<StateProvince[]> =>
  new Promise(resolve => setTimeout(() => resolve(getStatesForCountry(countryCode)), 80));
