...
import { useAllKnownCompanies, useAddProjectCompany } from '@/hooks/useProjects';
...
export const AssociateCompanyModal = ({ projectId, currentCompanyNames, open, onOpenChange }: AssociateCompanyModalProps) => {
  ...
  const addProjectCompany = useAddProjectCompany();
  ...
  const availableCompanies = useMemo(() => {
    return allKnownCompanies
      .filter((company: any) => !currentCompanyNames.includes(company.companyName))
      .sort((a: any, b: any) => a.companyName.localeCompare(b.companyName));
  }, [allKnownCompanies, currentCompanyNames]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    addProjectCompany.mutate({ projectId, company: companyData, userId: currentUserId });
