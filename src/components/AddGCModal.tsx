...
export const AddGCModal = ({ siteId, open, onOpenChange }: AddGCModalProps) => {
  const { addSiteCompany } = useData();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      title: "Success",
      description: "General Contractor added successfully."
    });
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a general contractor for this job site.
          </DialogDescription>
        </DialogHeader>
