...
- [ ] **Step 1** — Add "+" buttons to Project Detail section headers
...
- [ ] **Step 2** — Note Create/Edit BottomSheet
...
- [ ] **Step 5** — Associate Existing Company BottomSheet
...
- [ ] **Step 6** — Create New Prospect (Full-screen)
...
- [ ] **Step 7** — Add Contact to Company BottomSheet
